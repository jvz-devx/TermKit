<script lang="ts">
	...
	import SftpBookmarksPane from './sftp/SftpBookmarksPane.svelte';
	import SftpDialogs from './sftp/SftpDialogs.svelte';
	import SftpEditorPane from './sftp/SftpEditorPane.svelte';
	import SftpFileListPane from './sftp/SftpFileListPane.svelte';
	import SftpToolbar from './sftp/SftpToolbar.svelte';
	import { createSftpBrowserController } from './sftp/sftp-browser-controller.svelte';
