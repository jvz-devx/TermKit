...
describe('RDP lifecycle helpers', () => {
	it('detects expired gateway tokens', () => {
		...
		expect(
			isGatewayExpired('2026-01-01T00:00:00.000Z', Date.parse('2026-01-02T00:00:00.000Z'))
		).toBe(true);
		expect(
			isGatewayExpired('2026-01-03T00:00:00.000Z', Date.parse('2026-01-02T00:00:00.000Z'))
		).toBe(false);
	});
