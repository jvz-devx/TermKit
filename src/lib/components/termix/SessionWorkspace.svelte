<script lang="ts">
	...
	import SessionWorkbenchBar from './session/SessionWorkbenchBar.svelte';
	import SessionWorkspaceHeader from './session/SessionWorkspaceHeader.svelte';
	...
	import { createSessionWorkspaceController } from './session/session-workspace-controller.svelte';
